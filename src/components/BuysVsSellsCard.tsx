...
const BuysVsSellsCard = () => {
  ...
  return (
    <div 
      className="border border-[hsl(var(--dashboard-border))] rounded-2xl p-3 h-full transition-all duration-300 hover:border-[hsl(var(--accent-neon-green)/0.25)]"
      style={{
        background: 'linear-gradient(180deg, #0D0D0D 0%, #121212 100%)',
        boxShadow: '0 0 1px hsl(var(--accent-neon-green) / 0.08)'
      }}
    >
