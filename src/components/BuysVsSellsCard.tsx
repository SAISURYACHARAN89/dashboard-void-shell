...
const BuysVsSellsCard = () => {
  ...
  return (
    <div 
      className="border border-[hsl(var(--dashboard-border))] rounded-2xl p-3 h-full transition-all duration-300 hover:border-[hsl(var(--dashboard-border)/0.6)] hover:shadow-sm"
      style={{
