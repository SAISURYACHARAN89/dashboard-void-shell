...
const WalletAgePlanetMapCard = () => {
  ...
  return (
    <div 
      className="border border-[hsl(var(--dashboard-border))] rounded-xl p-5 h-full flex flex-col transition-all duration-300 hover:border-[hsl(var(--dashboard-border))]/60 hover:shadow-lg group"
      style={{
