...
const WalletAgePlanetMapCard = () => {
  ...
  return (
    <div 
      className="border border-[hsl(var(--dashboard-border))] rounded-2xl p-5 h-full flex flex-col transition-all duration-300 hover:border-[hsl(var(--accent-neon-blue)/0.25)]"
      style={{
