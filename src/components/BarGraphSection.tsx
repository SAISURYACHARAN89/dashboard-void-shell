...
const BarGraphSection = () => {
  ...
  return (
    <div 
      className="border border-[hsl(var(--dashboard-border))] rounded-xl p-6 h-full transition-all duration-300 hover:border-[hsl(var(--dashboard-border))]/60 hover:shadow-lg group"
      style={{
